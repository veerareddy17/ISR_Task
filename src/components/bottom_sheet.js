...
function BottomSheet(props) {
  ...
  const onSubmit = async data => {
    // props.submit(data);
    await props.createOpportunityNoteAction(data);
  ...
  // componentDidMount() {
  //   console.log(
  //     'what is passing notes data to bottomsheet..=>',
  //     this.props.notesData,
  //   );
  //   if (this.props.notesData) {
  //     this.setState({
  //       title: this.props.notesData.title,
  //       date: this.props.notesData.date,
  //       comments: this.props.notesData.comments,
  //     });
  //   }
  // }
  renderItem = () => {
