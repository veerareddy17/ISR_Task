...
import {createAccountNotes} from '../../../action/accounts';
import uuid from 'react-native-uuid';
import {Buffer} from 'buffer';
global.Buffer = Buffer;

function CreateAccountNotes(props) {
  console.log('what is selected note is....=>', props.notesData);
  ...
  const onSubmit = async notesData => {
    // props.submit(data);
    var Id = uuid.v1({
    ...
    var data = {
      ParentId: props.selectedAccountCard.selectedAccount.Id,
