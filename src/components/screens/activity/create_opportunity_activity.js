...
import {createOpportunityActvity} from '../../../action/opportunity';
import useForm from 'react-hook-form';

function CreateOpportunityActivity(props) {
  ...
  const onSubmit = async data => {
    if (props.selectedOpportunityCard.selectedOpportunity) {
      await props.createOpportunityActvity(data);
      props.navigation.navigate('EditOpportunity', {
        ptitle: props.navigation.state.params.ptitle,
      });
    } else {
      Toast.show({
        text: 'Enter General Fields',
        buttonText: 'Okay',
        type: 'danger',
        position: 'top',
      });
      props.navigation.navigate('EditOpportunity', {
        title: props.navigation.state.params.ptitle,
      });
    }
  };
